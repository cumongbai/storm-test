package storm.rabbitmq.config;

import static storm.rabbitmq.config.ConfigUtils.addToMap;
import static storm.rabbitmq.config.ConfigUtils.getFromMap;
import static storm.rabbitmq.config.ConfigUtils.getFromMapAsBoolean;
import static storm.rabbitmq.config.ConfigUtils.getFromMapAsInt;
